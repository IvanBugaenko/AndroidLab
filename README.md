...
В результате работы был реализован экран, состоящий из всех компонентов. Также был создан репозиторий, в котором хранится история версий экрана (присутствует ветвление). Также был оформлен файл README.md, хранящий информацию о лабораторной работе, создан apk экрана, приложены скриншоты работы.
